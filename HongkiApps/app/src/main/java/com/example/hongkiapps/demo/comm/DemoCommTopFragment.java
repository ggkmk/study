...
public class DemoCommTopFragment extends Fragment implements DemoCommListener {
    private static final String TAG = DemoCommTopFragment.class.getSimpleName();
    ...
    // Constructors
    // --------------------------------------------------------------------------------
    public static DemoCommTopFragment newInstance() {
        return new DemoCommTopFragment();
    }
    ...
    public View onCreateView(
        ...
        mViewHolder = new ViewHolder(
                (ViewGroup)inflater.inflate(R.layout.fragment_demo_communicate_top, container, false));
        mViewHolder.actionButton.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                if(mCaster == null) return;
                mCaster.requestToAction(
                        mViewHolder.actionButton.getText().toString(), DemoCommTopFragment.this);
            }
        });
    ...
    private static class ViewHolder {
        ...
        ViewHolder(ViewGroup rootPane) {
            ...
            this.logTextView = rootPane.findViewById(R.id.fragmentDemoCommunicateTop_logTextView);
            this.actionButton = rootPane.findViewById(R.id.fragmentDemoCommunicateTop_actionButton);
        }
    }
}